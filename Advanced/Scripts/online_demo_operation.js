...
//************************** Save Image 2***********************************
//-------------------------------------------------------------------------------------- 
function btnSave_onclick2(user) {     
    ...
    var strFilePath = "C:\\Users\\" + user + "\\Desktop\\Uploads\\" +  _txtFileNameforSave.value + "." + strimgType_save;  
...
//                                {
//                                    alert(strFilePath);
//                                    bSave = DWObject.SaveAsJPEG(strFilePath, $i); 
//                                }
//                        }
//                        else
                    bSave = DWObject.SaveAsJPEG(strFilePath, DWObject.CurrentImageIndexInBuffer);break;                                
            case 2: bSave = DWObject.SaveAsTIFF(strFilePath, DWObject.CurrentImageIndexInBuffer); break;
            case 3: bSave = DWObject.SaveAsPNG(strFilePath, DWObject.CurrentImageIndexInBuffer); break;
            case 4: bSave = DWObject.SaveAsPDF(strFilePath, DWObject.CurrentImageIndexInBuffer); break;
        }
    ...
    if (bSave)
     {   _strTempStr = _strTempStr + "<b>Save Image: </b>"; alert("File Saved Successfully !!!"); }
    if (checkErrorString()) {
        return;
    }
}
