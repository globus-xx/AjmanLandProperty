...
class Letters extends CActiveRecord
{
	...
	//		array('DocumentNumber', 'length', 'max'=>25),
			...
			array('LetterID, Title,LetterText ', 'safe', 'on'=>'search'),
			array('LetterID, Title,LetterText', 'safe'),
...
//	}
	...
	public function search()
	{
		...
		$criteria->compare('Title',$this->Title,true);
                $criteria->compare('LetterText',$this->LetterText,true);
