...
<form action="letterupdate" method="post">

<table>
<tr><td>محتوى الملف</td><td>:</td><td> <textarea id="elm1" name="ftext" rows="15" cols="100" ><?php echo $text ?></textarea></td></tr>
<tr><td colspan="3"><input type="hidden" name="title" value="<?php echo $title ?>" ><input type="submit" name="go" value="تعديل و عودة للسابق">&nbsp; &nbsp; </td></tr>
</table>
