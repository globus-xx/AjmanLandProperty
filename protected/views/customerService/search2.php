...
<form action="Letters/generatefile" method="post" id="letterForm" name="letterForm">
...
//			var paramJSON = JSON.stringify("action=search&str
				...
				data: "action=generatefile&landid="+$("#searchstring").val()+"&letterid=12&destination=12",
                                async:false,
		...
		{   
                    ...
                    if(typeof(Results["current"]["customers"])!="undefined"){
                        ...
                        for(var i = 0; i<arrayNode.length ; i++ ){
                            currentOwnersContent+="<tr><td> <a class='searchLink' >"+ arrayNode[i]["CustomerNameArabic"]+"</a></td>";
                     ...
                     if(typeof(Results["previous"])!="undefined"){
                        ...
                        previousOwnersContent+="<tr><td>customer name </td><td> customer nationality</td></tr>";
                           for(var j= 0; j<arrayNodeB.length; j++){ 
                                ...
                                for(var i = 0; i<arrayNode.length ; i++ )
                                previousOwnersContent+="<tr class="+arrayNodeB[j]["deed"]+"><td> <a class='searchLink' >"+ arrayNode[i]["CustomerNameArabic"]+"</a></td><td>"+ arrayNode[i]["Nationality"]+"</td></tr>";
