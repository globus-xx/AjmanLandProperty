...
*/
			...
			if ($landinfo) //if i found it... 
			{
				...
				if ($deeds)
				{
					...
					foreach($deeds as $deed)
					{
						...
						{
							$result->deedDetails[] =$deedline->Share."---------------".$deedline->customer->CustomerNameArabic."   ID".$deedline->CustomerID."eID";
							$result->customerID[] = $deedline->CustomerID;
	...
	public function actionPrint($id)
	{
		...
		$deedtracker->UserID = $r[0]; //Yii::app()->User->ID;
