...
class HajzMasterController extends Controller
{
	/**
...
//			'postOnly + delete', // we only allow deletion via POST request
	...
	public function accessRules()
	{
		return array(
			...
			array('allow',
				...
				'users'=>array('yalmheiri','aalshamsi'),
			),
	...
	{
		$dataProvider=new CActiveDataProvider('HajzMaster');
	...
	{
		$model=new HajzMaster('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['HajzMaster']))
			$model->attributes=$_GET['HajzMaster'];
	...
	{
		$model=HajzMaster::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hajz-master-form')
		{
