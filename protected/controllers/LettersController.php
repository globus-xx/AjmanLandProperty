...
//print_r($customerResult);
        ...
        /**
         * action to View the template generation page 
         */
...
//            $this->render('template');
        ...
        public function actionView($id)
	{
        ...
        /**
         * action to view the page of the letters update 
         * @param type $id
         */
...
//			{	$res3[] = $r." * "; }
        ...
        /**
         * action to Delete any letter from the list
         * @param type $id
         */
...
//		  $this->render('convert');
        ...
        /**
         * action to view the letter open page 
         * @param type $id
         */
...
//            echo $text;
        ...
        /**
         * action to view the exported letters generated by user
         * @param type $id
         */
        public function actionviewExportedLetters($id)
	{
        ...
        /**
         * action to make download letter as word file
         * @param type $id
         */
